...
// in assetwize/test/features/profile/domain/usecases/update_phone_number_test.dart.
...
class MockProfileRepository extends _i1.Mock implements _i3.ProfileRepository {
  ...
  @override
  _i4.Future<void> updateProfile(_i2.UserProfile? profile) =>
      (super.noSuchMethod(
        Invocation.method(
          #updateProfile,
          [profile],
  ...
  @override
  _i4.Future<void> updateName(String? name) => (super.noSuchMethod(
        Invocation.method(
          #updateName,
          [name],
        ),
  ...
  @override
  _i4.Future<void> updatePhoneNumber(String? phoneNumber) =>
      (super.noSuchMethod(
        Invocation.method(
          #updatePhoneNumber,
          [phoneNumber],
  ...
  @override
  _i4.Future<void> clearProfile() => (super.noSuchMethod(
        Invocation.method(
          #clearProfile,
          [],
        ),
